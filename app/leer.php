        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="alert alert-primary " role="alert">
                    ...
                    <a href="leer.php?id=<?php echo $dato['id'] ?>" class="float-right">
            ...
            <div class="col-md-6">
                ...
                <h3>Agrega tu Poema Preferido:</h3>
                <form method="POST" >
                    <label for="" class="formulario__label mt-3">Autor:</label>
                    <input type="text" class="form-control mt-3" name="peliculas">
                    <label for="" class="formulario__label mt-3">Poema:</label>
                ...
                <?php if($_GET): ?>
                <h3>Edita tu Poema de Preferencia:</h3>
